                    ...
                    <tr access_id="{{$u->id_p}}">
                      ...
                      <td>
                        ...
                        <div class="btn-group flex-wrap">
  												...
  												<a class="dropdown-item text-1 text-danger" href="{{ url('api/del_review_product/'.$u->id_p) }}" onclick="return confirm('Are you sure?')">ลบ</a> 
  												</div>
  											</div>
...
$(document).ready(function(){
  $("input:checkbox").change(function() {
	...
	$.ajax({
					type:'POST',
					url:'{{url('api/post_status_re_product')}}',
