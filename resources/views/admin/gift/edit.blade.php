                        ...
                        <div class="col-md-8 col-lg-8">
                              ...
                              <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                          ...
                                          {{ csrf_field() }}
          											...
          											<h4 class="mb-xlg">แก้ไขส่วนลด</h4>
          											...
          											<fieldset>
                                                        ...
                                                        <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="number" class="form-control" name="detail"  value="{{ $objs->detail }}">
          													</div>
          												</div>
                                                        ...
                                                        <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="code" id="my_code" value="{{ $objs->code }}">
          													</div>
          												</div>
                                                          ...
                                                          <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" data-plugin-datepicker class="form-control" name="start" value="{{ $objs->start }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" data-plugin-datepicker class="form-control" name="end" value="{{ $objs->end }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <label class="col-md-3 control-label" for="exampleInputEmail1">รูปภาพ*</label>
                                                            ...
                                                            <img src="{{ url('assets/banner/'.$objs->image) }}" style="width: 220px; border: 2px solid #439aff;" >
                                                                <br />
                                                                <br />
                                                        ...
                                                        <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="number" class="form-control" name="total" value="{{ $objs->total }}" >
          													</div>
          												</div>
