        ...
        <section role="main" class="content-body">
          ...
          <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                          <br />
          <img src="{{ url('assets/banner/'.$objs->image) }}" style="width: 650px; border: 2px solid #439aff;" >
          <br />
          <br />
                          ...
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-9">
                                      <textarea class="form-control" name="image_url" rows="9">{{ $objs->image_url }}</textarea>
          													</div>
          												</div>
